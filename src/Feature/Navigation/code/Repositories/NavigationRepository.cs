namespace Sitecore.Feature.Navigation.Repositories
{
    ...
    public class NavigationRepository : INavigationRepository
    {
        ...
        private NavigationItems GetChildNavigationItems(Item parentItem, int level, int maxLevel)
        {
            ...
            {
                HeaderTitle = parentItem.FieldHasValue(Templates.LinkMenu.Fields.HeaderTitle) ? parentItem.Field(Templates.LinkMenu.Fields.HeaderTitle) : new HtmlString(string.Empty),
