namespace Sitecore.Feature.Navigation
{
    ...
    public struct Templates
    {
        ...
        public struct LinkMenu
        {
            public struct Fields
            {
                public static readonly ID ShowHeaderTitle = new ID("{B2FF8B29-17EE-4EDF-9C1F-0DBB7CD27DB8}");

                public static readonly ID HeaderTitle = new ID("{4D4BB1E0-7410-48A2-9917-9FA5EFD9C838}");
