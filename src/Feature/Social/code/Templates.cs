  ...
  public struct Templates
  {
    ...
    public struct TwitterFeed
    {
      ...
      public struct Fields
      {
        ...
        {
            public static ID ID = new ID("{BEE79706-E857-433C-A69A-3711A1477363}");

            public struct Fields
            {
                public static readonly ID FeedTitle = new ID("{B7CE7660-7D69-4C1E-B74C-82BD49563069}");
                public static readonly ID LeadersImage = new ID("{46031548-AB53-4F58-A846-8577465A7233}");
                public static readonly ID LeaderDesignation = new ID("{B0FFF664-1AB7-4B2B-B1F9-4558F910A4DF}");
                public static readonly ID Description = new ID("{6F6DF91A-AAD1-4299-BB47-1C56B350FF91}");
            }
        }
