namespace Sitecore.Feature.Media
{
    ...
    public struct Templates
    {
        ...
        public struct HasMediaBackgroundImage
        {
            public static readonly ID ID = new ID("{66041A9C-1219-4C3E-8268-C769B7922EDC}");

            public struct Fields
            {
                public static readonly ID BackgroundImage = new ID("{B8839D85-7E29-426D-86EC-1A6C38804A0B}");
            }
        }

        public struct HasMediaLink
        {
            public static readonly ID ID = new ID("{E5947666-C2D4-4383-90F5-66762232960C}");

            public struct Fields
            {
                public static readonly ID LinkText = new ID("{C8699F3B-0294-4742-9982-541139BB1167}");

                public static readonly ID LinkItem = new ID("{6246CF8B-3FEB-4C4A-BC95-9A03E0C84480}");
